...
<div class="container">
    ...
    <div id="add-expense-page">
        <?= form_open("expense/update/".$eID);?>
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                            <input value="<?= $exp['name'];?>" type="text" class="form-control" name="name" value="" required autofocus>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="remarks" rows="5"><?= $exp['remarks'];?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 mg-t-20">
                    <div class="mg-b-20 table-repeater">
                        <table class="table table-bordered" data-max-row="12">
                            ...
                            <tbody id="texpense">
                                <?php foreach($summexpense as $sexp){?>
                                <tr>
                                    <td>
                                        <select name="expense-category[]" class="custom-select" required>
                                            <option value="<?= $encrypter->encrypt($sexp['expense_category_id'])?>"><?= $sexp['category']?></option>
                                            <?php foreach($category as $cate){?>
                                                <option value="<?= $encrypter->encrypt($cate['expense_category_id']);?>"><?= $cate['name']?></option>
                                            <?php }?>
                                        </select>
                                    </td>
                                    <td><input class="form-control" type="text" name="expense-description[]" value="<?= $sexp['description']?>" required></td>
                                    <td><input class="form-control" type="text" name="expense-amount[]" value="<?= $sexp['amount']?>" required></td>
                    ...
                    <div class="mg-b-20 table-repeater">
                        ...
                        <table class="table table-bordered" data-max-row="12">
                            ...
                            <tbody id="tpaymentdetails">
                                ...
                                <tr>
                                    <td>
                                        <input type="hidden" name="payment-id" value="<?= $encrypter->encrypt($ph['payment_id'])?>">
                                        <select name="payment-method[]" class="custom-select">
                                            <option value="<?= $ph['method']?>" selected><?= ucfirst($ph['method'])?></option>
                                    ...
                                    <td data-name="description">
                                        ...
                                        <div data-name="check" class="<?php if($ph['method'] == 'check'){echo 'd-block';}else{echo 'd-none';}?> mg-t-5">

                                            <div class="mg-b-10">
                                                <label>Bank Account</label>
                                                <select name="payment-bank-account[]" class="form-control">
                                                    <option value="<?= $encrypter->encrypt($ph['bank_account_id'])?>"><?= $ph['bank_account']?></option>
                                            ...
                                            <div class="mg-b-10">
                                                <label>Payee</label>
                                                <input type="text" class="form-control" name="payment-check-payee[]" value="<?= $ph['check_payee']?>">
                                            </div>

                                            <div class="mg-b-10">
                                                <label>Check Number</label>
                                                <input type="text" class="form-control" name="payment-check-number[]" value="<?= $ph['check_number']?>">
                                            </div>
                                        </div>

                                    </td>
                                    <td><input class="form-control" type="text" name="payment-amount[]" value="<?= $ph['amount']?>" required></td>
            ...
            <button type="submit" name="save" class="btn btn-primary mr-2">Update Expense</button>
        <?= form_close();?>
    </div>
