...
<div class="container">
    ...
    <?php
        ...
        if(!empty($_SESSION['salesshop_added'])){
            echo '<div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Shopee Item Registration Success!</h4>
            <p>Shopee Item has been successfully added</p>
        </div>';
            unset($_SESSION['salesshop_added']);
        }
        
    ?>

    <h1>Add Shopee Sales <i class="fak fa-shopee"></i></h1>


    <div id="add-sales-page">
        <?= form_open("shopee/save");?>
            <div class="row">
                <div class="col-lg-3">
