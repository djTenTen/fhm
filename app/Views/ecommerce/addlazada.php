...
<div class="container">
    ...
    <?php
        ...
        if(!empty($_SESSION['saleslaz_added'])){
            echo '<div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Lazada Item Registration Success!</h4>
            <p>Lazada Item has been successfully added</p>
        </div>';
            unset($_SESSION['saleslaz_added']);
        }
        
    ?>

    <h1>Add Lazada Sales <i class="fak fa-lazada"></i></h1>


    <div id="add-sales-page">
        <?= form_open("lazada/save");?>
            <div class="row">
                <div class="col-lg-3">
